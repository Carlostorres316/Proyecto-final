    ...
    <div class="form-card">
        <form action="{{ route('admin.cursos.update', $curso->id) }}" method="POST">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('user_id') is-invalid @enderror" id="user_id" name="user_id" required>
                        ...
                        @foreach($profesores as $profesor)
                            <option value="{{ $profesor->id }}" {{ old('user_id', $curso->user_id) == $profesor->id }}>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select " id="subcategoria_id" name="subcategoria_id" required>
                        ...
                        @foreach($subcategorias as $subcategoria)
                            <option value="{{ $subcategoria->id }}" {{ old('subcategoria_id', $curso->subcategoria_id) == $subcategoria->id }}>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="nivel" name="nivel" required>
                        ...
                        <option value="principiante" {{ old('nivel', $curso->nivel) == 'principiante' }}>Principiante</option>
                        <option value="intermedio" {{ old('nivel', $curso->nivel) == 'intermedio' }}>Intermedio</option>
                        <option value="avanzado" {{ old('nivel', $curso->nivel) == 'avanzado' }}>Avanzado</option>
                    </select>
                    @error('nivel')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary-modern">Actualizar Curso</button>
            </div>
        </form>
    </div>
</div>
